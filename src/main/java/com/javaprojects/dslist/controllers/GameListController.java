...
import com.javaprojects.dslist.dto.ListReplacementDTO;
import com.javaprojects.dslist.services.GameListService;
...
public class GameListController {
  ...
  public void move(@PathVariable Long listId, @RequestBody ListReplacementDTO body) {
    gameListService.move(listId, body.getSourceIndex(), body.getDetinationIndex());
  }
}
